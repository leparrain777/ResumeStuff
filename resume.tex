  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
	   ...
	   \item Independently developed the skills and knowlege base to be able to successfuly 3D-print a large variety of 3D models so that as a team we could both continue teaching students how to opperate a 3D-printer, and integrate 3D-printing into our design process. Previously, 3D-printing had been a student lead project of which all students suddenly left the team, and our printer only got used by our public relations subteam as a means to advertise due to reliability issues.
          \end{itemize}
          }
      \resumeItemListEnd
