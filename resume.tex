...
%        \end{itemize}
    ...
    \resumeSubItem{Dota 2 Modding}
      {Created a script that generates a complete text file organizing key value pairs that are randomized withing certain bounds for a Dota 2 custom game mode. Ongoing: Learning Lua scripting using Dota specific documentation and other users github projects to create multiple of my own custom game modes.}
    ...
    \resumeSubItem{Volunteer Fireworks Salesman}
      {Served 3+ years as a fireworks salesman for the local band and the local robotics team on years they are selected to have a booth. Roughly 6-6.5 hours every day for a week once a year helping customers find the perfect composition of fireworks to fit their needs and their budget. Personal note: I find this extremely enjoyable as a change of pace from my usual activities and take pride in having seen and memorized almost all of the various fireworks we sell and establishing a general bang/buck rating. Aside from just taking a break, waiting for my diploma, and Covid-19, wanting to participate in this years fireworks season is the main reason for the March to July 2020 gap. I have been working on coding projects/learning in the meantime.}
